        ...
        <div className="flex flex-row  gap-4">
          <div className="flex flex-col">
            <p className="mt-8 col-span-2 my-6">
              ...
              <b>1.การจัดสัมนาและ workshop : </b> IoT Library & Cafe มีการจัดสัมมนาและเวิร์คช็อปเกี่ยวกับเทคโนโลยี IoT และการพัฒนาเว็บด้วย FastAPI และ React เป็นประจำ ซึ่งให้โอกาสในการเรียนรู้และแลกเปลี่ยนความรู้กับผู้เชี่ยวชาญและเพื่อนๆ ที่มีความสนใจเหมือนกัน <br/>
              ...
              <b>4.บริการกาแฟและเครื่องดื่ม : </b> นอกจากความรู้และการพัฒนาทักษะแล้ว เราก็ยังมีบริการกาแฟและเครื่องดื่มที่หลากหลายให้คุณได้เพลิดเพลิน ทั้งกาแฟสด น้ำผลไม้ และของว่างที่ทำจากวัตถุดิบคุณภาพ <br/>
